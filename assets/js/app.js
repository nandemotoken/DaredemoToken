...
const start = async () => {
    ...
    document.getElementById('address').addEventListener("mouseover",(e)=>{document.getElementById('addressLink').style.color= "rgb(20,33,47);"})
    document.getElementById('address').addEventListener("mouseleave",(e)=>{document.getElementById('addressLink').style.color= "rgb(0,118,255)"})
