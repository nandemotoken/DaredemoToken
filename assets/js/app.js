...
const start = async () => {
    ...
    document.getElementById('addressLink').addEventListener("mouseover",(e)=>{document.getElementById('addressIcon').style.color= "rgb(20,33,47)";document.getElementById('addressinfo').style.color= "rgb(20,33,47)"})
